...
const NewFeaturePage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      <button
        className="lg:hidden p-4 text-white bg-black"
      ...
      >
        ...
        <ul className="space-y-6">
          {/* New Section */}
          <li>
            <h2 className="font-bold text-lg text-gray-800 mb-4">New (500)</h2>
          ...
          <li>
            <h2
              className="font-bold text-lg text-gray-800 cursor-pointer flex justify-between items-center"
