    ...
    <div className="flex flex-col lg:flex-row p-6 max-w-screen-lg mx-auto">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between">
        ...
        <div className="mt-4 flex items-center">
          <span className="text-xl sm:text-2xl font-bold text-gray-800">₹ 8,695.00</span>
        </div>

        {/* Add to Cart Button with Custom Styles */}
        <button className="mt-6 bg-black text-white py-[7.5px] px-[23.92px] flex items-center gap-2 rounded-[30px_0px_0px_0px] hover:bg-gray-800 w-full sm:w-auto">
